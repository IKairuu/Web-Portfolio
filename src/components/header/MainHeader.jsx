...
export const MainHeader = () => {
  const { isActive, changeActive } = useMenuStore();
  return (
    <div>
      <div className="flex justify-between items-center w-full">
        ...
        <button className="md:hidden cursor-pointer" onClick={changeActive}>
      ...
      {isActive ? (
        <div className="text-white flex items-center title-labels mt-4 md:hidden animate-fade-in">
          <button className="mx-2 cursor-pointer hover:bg-linear-to-r from-blue-500 to-purple-500 bg-clip-text hover:text-transparent hover:animate-pulse">
            Home
          </button>
